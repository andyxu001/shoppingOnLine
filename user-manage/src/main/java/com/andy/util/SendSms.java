...
/**
 * https://help.aliyun.com/document_detail/431631.html?spm=a2c4g.431631.0.0.99f7de53Ueh2zu
 */
public class SendSms {
     ...
     * 添加短信模板
     */
    private String addSmsTemplate() throws ClientException, com.aliyuncs.exceptions.ClientException {
        CommonRequest addSmsTemplateRequest = new CommonRequest();
        addSmsTemplateRequest.setMethod(MethodType.POST);
        addSmsTemplateRequest.setSysDomain("dysmsapi.aliyuncs.com");
        addSmsTemplateRequest.setSysAction("AddSmsTemplate");
        addSmsTemplateRequest.setSysVersion("2023-04-24");
     ...
     * 发送短信
     */
    private String sendSms(String templateCode) throws ClientException, com.aliyuncs.exceptions.ClientException {
        ...
        // 接收短信的手机号码
        request.putQueryParameter("PhoneNumbers", "13814829510");
     ...
     * 查询发送详情
     */
    private void querySendDetails(String bizId) throws ClientException, com.aliyuncs.exceptions.ClientException {
        CommonRequest request = new CommonRequest();
        request.setSysDomain("dysmsapi.aliyuncs.com");
        request.setSysVersion("2017-05-25");
    ...
    public static void main(String[] args) {
        SendSms sendSmsDemo = new SendSms();
